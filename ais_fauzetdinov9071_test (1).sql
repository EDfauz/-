...
--
-- Хост: mysql
-- Время создания: Май 31 2025 г., 06:38
...
CREATE TABLE `flat` (
  ...
  `size` int NOT NULL COMMENT 'Площадь квартиры',
  `flat_number` int NOT NULL COMMENT 'Номер квартиры'
...
INSERT INTO `flat` (`id`, `id_house`, `size`, `flat_number`) VALUES
(1, 1, 73, 1),
(2, 1, 90, 2),
(3, 1, 110, 3),
(4, 2, 90, 1),
...
(4, 1, 'Реконструкция дома'),
(5, 1, 'Благоустройство земельного участка'),
(6, 2, 'Замена домофона'),
(7, 2, 'Ремонт общего имущества '),
(8, 2, 'Замена лифта '),
(9, 3, 'Обшивка дома '),
(10, 3, 'Замена щитов ');
...
--
ALTER TABLE `meeting_question`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'id вопроса собрания', AUTO_INCREMENT=11;
